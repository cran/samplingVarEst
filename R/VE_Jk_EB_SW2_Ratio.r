VE.Jk.EB.SW2.Ratio <- function(VecY.s, VecX.s, VecPk.s, nII, VecPi.s, VecCluLab.s, VecCluSize.s)
{
  ...
  VarianceClusters                           <- .C("VE_Jk_EB_SW2_Ratio_Clu",
                                                    as.double(EstTheta),
                                                    as.double(VecY.s),
                                                    as.double(VecX.s),
                                                    as.double(VecPk.s),
  ...
  SQVecPseudo_s                              <- ( (n-1)/n * (EstTheta - VecEstTheta_k) )^2
  VectClusterSumSqPseudoValues               <- rowsum(SQVecPseudo_s, group = VecCluLab.s)
