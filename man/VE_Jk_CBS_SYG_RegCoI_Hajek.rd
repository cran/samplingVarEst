\name{VE.Jk.CBS.SYG.RegCoI.Hajek}
\alias{VE.Jk.CBS.SYG.RegCoI.Hajek}
\title{The Campbell-Berger-Skinner unequal probability jackknife variance estimator for the estimator of the intercept regression coefficient using the Hajek point estimator (Sen-Yates-Grundy form)}
\description{Computes the Campbell(1980); Berger-Skinner(2005) unequal probability jackknife variance estimator for the estimator of the intercept regression coefficient using the Hajek (1971) point estimator. It uses the Sen (1953); Yates-Grundy(1953) variance form.  }
\usage{VE.Jk.CBS.SYG.RegCoI.Hajek(VecY.s, VecX.s, VecPk.s, MatPkl.s)}
\arguments{
...
\deqn{\hat{V}(\hat{\alpha}_{Hajek}) = \frac{-1}{2}\sum_{k\in s}\sum_{l\in s} \frac{\pi_{kl}-\pi_k\pi_l}{\pi_{kl}} (\varepsilon_k - \varepsilon_l)^{2}}
where
...
\seealso{
\code{\link{VE.Jk.CBS.SYG.RegCo.Hajek}}\cr\code{\link{VE.Jk.Tukey.RegCoI.Hajek}}\cr\code{\link{VE.Jk.CBS.HT.RegCoI.Hajek}}\cr\code{\link{VE.Jk.B.RegCoI.Hajek}}\cr\code{\link{VE.Jk.EB.SW2.RegCoI.Hajek}}
}
\examples{
