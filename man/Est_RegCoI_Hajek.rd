\name{Est.RegCoI.Hajek}
\alias{Est.RegCoI.Hajek}
\title{Estimator of the intercept regression coefficient using the Hajek point estimator}
\description{Estimates the population intercept regression coefficient using the Hajek (1971) point estimator.  }
\usage{Est.RegCoI.Hajek(VecY.s, VecX.s, VecPk.s)}
\arguments{
...
\seealso{
\code{\link{Est.RegCo.Hajek}}\cr\code{\link{VE.Jk.Tukey.RegCoI.Hajek}}\cr\code{\link{VE.Jk.CBS.HT.RegCoI.Hajek}}\cr\code{\link{VE.Jk.CBS.SYG.RegCoI.Hajek}}\cr\code{\link{VE.Jk.B.RegCoI.Hajek}}\cr\code{\link{VE.Jk.EB.SW2.RegCoI.Hajek}}
}
\examples{
