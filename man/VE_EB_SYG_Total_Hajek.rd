\name{VE.EB.SYG.Total.Hajek}
\alias{VE.EB.SYG.Total.Hajek}
\title{The Escobar-Berger unequal probability replicate variance estimator for the Hajek (1971) estimator of a total (Sen-Yates-Grundy form)}
\description{Computes the Escobar-Berger (2013) unequal probability replicate variance estimator for the Hajek estimator of a total. It uses the Sen (1953); Yates-Grundy(1953) variance form.  }
\usage{
...
\deqn{\hat{V}(\hat{t}_{Hajek}) = \frac{-1}{2}\sum_{k\in s}\sum_{l\in s} \frac{\pi_{kl}-\pi_k\pi_l}{\pi_{kl}} (\breve{\nu}_k - \breve{\nu}_l)^{2}}
where
...
\seealso{
\code{\link{VE.Jk.Tukey.Total.Hajek}}\cr\code{\link{VE.Jk.CBS.HT.Total.Hajek}}\cr\code{\link{VE.Jk.B.Total.Hajek}}\cr\code{\link{VE.Jk.EB.SW2.Total.Hajek}}\cr\code{\link{VE.EB.SYG.Total.Hajek}}
}
\examples{
