\name{VE.EB.HT.Mean.Hajek}
\alias{VE.EB.HT.Mean.Hajek}
\title{The Escobar-Berger unequal probability replicate variance estimator for the Hajek (1971) estimator of a mean (Horvitz-Thompson form)}
\description{Computes the Escobar-Berger (2013) unequal probability replicate variance estimator for the Hajek estimator of a mean. It uses the Horvitz-Thompson (1952) variance form.  }
\usage{
...
\deqn{\hat{V}(\hat{\bar{y}}_{Hajek}) = \sum_{k\in s}\sum_{l\in s} \frac{\pi_{kl}-\pi_k\pi_l}{\pi_{kl}} \breve{\nu}_k \breve{\nu}_l}
where
...
\seealso{
\code{\link{VE.Jk.Tukey.Mean.Hajek}}\cr\code{\link{VE.Jk.CBS.SYG.Mean.Hajek}}\cr\code{\link{VE.Jk.B.Mean.Hajek}}\cr\code{\link{VE.Jk.EB.SW2.Mean.Hajek}}\cr\code{\link{VE.EB.SYG.Mean.Hajek}}
}
\examples{
