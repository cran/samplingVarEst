...
\arguments{
\item{VecY.s}{vector of the variable of interest; its length is equal to \eqn{n}, the total sample size. Its length has to be the same as the length of VecPk.s. There must not be any missing value.}
