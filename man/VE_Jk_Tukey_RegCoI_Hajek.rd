...
\seealso{
\code{\link{VE.Jk.Tukey.RegCo.Hajek}}\cr\code{\link{VE.Jk.CBS.HT.RegCoI.Hajek}}\cr\code{\link{VE.Jk.CBS.SYG.RegCoI.Hajek}}\cr\code{\link{VE.Jk.B.RegCoI.Hajek}}\cr\code{\link{VE.Jk.EB.SW2.RegCoI.Hajek}}
}
\examples{
