...
\arguments{
\item{VecPk.U}{vector of the first-order inclusion probabilities; its length is equal to the population size. Values in \code{VecPk.U} must be greater than zero and less than or equal to one. There must not be missing values.}
}
\details{
